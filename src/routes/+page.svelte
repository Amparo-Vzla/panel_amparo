...
<div class="grid grid-cols-1 md:grid-cols-2 min-h-screen md:h-screen w-full">
    ...
    <div class="flex flex-col justify-center p-8 md:p-16 bg-white min-h-screen md:min-h-0 h-full">
        <div class="max-w-sm w-full mx-auto space-y-6">
            ...
            <!-- USAMOS EL ENHANCE PROPIO DE SUPERFORMS -->
            <form method="POST" class="space-y-4" use:enhance>
                ...
                <!-- $delayed SE ENCARGA DEL ESTADO DE CARGA AUTOMÁTICAMENTE -->
                <button 
                    type="submit" 
                    disabled={$delayed}
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-big-right-dash-icon lucide-arrow-big-right-dash">
